...
extension WidgetPaddingX on Widget {
  ...
  Widget paddingHorizontal(double horizontal) =>
      Padding(padding: EdgeInsets.symmetric(horizontal: horizontal), child: this);

  Widget paddingVertical(double vertical) => Padding(padding: EdgeInsets.symmetric(vertical: vertical), child: this);

  Widget get defaultPageMargin =>
      Padding(padding: const EdgeInsets.symmetric(horizontal: 20.0, vertical: 0.0), child: this);
